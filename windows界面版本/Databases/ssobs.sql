...
CREATE TABLE `logs`  (
  `userId` varchar(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_croatian_ci NULL DEFAULT NULL,
  `times` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_croatian_ci NULL DEFAULT NULL,
  `logContext` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_croatian_ci NULL DEFAULT NULL
...
INSERT INTO `logs` VALUES ('000007', '2022-06-20_18.21.08', '用户登录系统');
INSERT INTO `logs` VALUES ('000007', '2022-06-20_18.21.22', '用户查询余额');
INSERT INTO `logs` VALUES ('000007', '2022-06-20_18.21.27', '用户取款，金额：1.0');
INSERT INTO `logs` VALUES ('000007', '2022-06-20_18.21.33', '用户存款，金额：2.0');
INSERT INTO `logs` VALUES ('000007', '2022-06-20_18.21.49', '转账给用户:aaa,转账金额：1.0');
INSERT INTO `logs` VALUES ('000009', '2022-06-20_18.21.49', '收到用户：ooo的转账，转账金额：1.0');
INSERT INTO `logs` VALUES ('000007', '2022-06-20_18.22.07', '用户查看帮助手册');
INSERT INTO `logs` VALUES ('000007', '2022-08-09_22.17.32', '鐢ㄦ埛鐧诲綍绯荤粺');
...
CREATE TABLE `user`  (
  `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_croatian_ci NULL DEFAULT NULL,
...
INSERT INTO `user` VALUES ('000007', 7, 'ooo', '1234', 915.00);
INSERT INTO `user` VALUES ('000008', 8, 'qwer', '000', 4.00);
INSERT INTO `user` VALUES ('000009', 9, 'aaa', '123456', 93.00);
INSERT INTO `user` VALUES ('000010', 10, 'uuu', '123', 10184.00);
...
INSERT INTO `user` VALUES ('000015', 15, NULL, NULL, NULL);
INSERT INTO `user` VALUES ('000016', 16, '000033', '12', 0.00);
